...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-50 flex flex-col items-center gap-0.5 rounded-2xl bg-[#25D366] px-4 py-3 shadow-lg transition-transform hover:scale-105 hover:shadow-xl"
    >
